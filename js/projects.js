		...
		$.getJSON(projectsUrl,function (data){
			...
			function writeContributors(contributors)
			{
				...
				for (i=0; i < contributors.length;i++)
				{
					...
					$(contributorRow).append("<div class='col-md-4'><div><a href='" +contributors[i].web+"'><img src='" + contributors[i].logo+ "' style='max-height:200;width:200;'/></a></div>");
			...
			require(["typeahead"], function(typeahead) {
				...
				}).bind('typeahead:selected', function(obj, datum, name) {writeProjects(data["projects"],datum.value);});
			});
